...
#define DATA8080_GPIO_PORT              GPIOD
#define DATA8080_GPIO_PIN               GPIO_PIN_All                                  /* 16个IO都用到 */
#define DATA8080_GPIO__CLK_ENABLE() 	 do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* 所在IO口时钟使能 */
